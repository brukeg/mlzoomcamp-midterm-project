...
You can read more about the data on Kaggle: https://www.kaggle.com/datasets/rkiattisak/salaly-prediction-for-beginer
...
You only need to change the values in this line of the curl request:
`-d '{"age":44,"gender":"female","education_level":"masters","job_title":"senior_data_engineeR","years_of_experience":15}' \`
...
## Making the request
You have 5 feature to play around with
...
curl -s -X POST http://127.0.0.1:9696/predict \
-H "Content-Type: application/json" \
-d '{"age":<choose-your-age>,"gender":"<choose a gender>","education_level":"<choose-an-ed-level>","job_title":"<choose-a-valid-job-title>","years_of_experience":<choose-yoe>}' \
| jq
```